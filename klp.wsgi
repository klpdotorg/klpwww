...
class text:
  def GET(self, name):
    web.header('Content-Type','text/html; charset=utf-8')
    textlinks = {'library': 'library', 'maths': 'maths', 'preschool': 'preschool', 'reading': 'reading', 'partners': 'partners','aboutus':'aboutus','credits':'credits', 'reports':'reports', 'disclaimer':'disclaimer','volunteer':'volunteer','donate':'donate','english':'english','sikshana':'sikshana'}
...
class listFiles:
  def GET(self,type):
    ...
    if (int(type) == 1 or int(type) == 3):
      ...
      fileList["reptype"] = ["demographics","finances","infrastructure","library","learning"]
