...
{
  document.getElementById("sysinfo").innerHTML = "Share your stories of visits to schools... We are counting <a href=\"/map\" target=\"_blank\"> <img src='/images/legacy/sys_icon.png'/><span style='color:white;font-weight:bold'> " + info["numstories"] + "</span> shared experiences  <img src='/images/legacy/cam_icon.png'/><span style='color:white;font-weight:bold'> " + info["numimages"] + "</span> shared images</a> as on today!"
}
