...
statements = {'get_district':"select bcoord.id_bndry,ST_AsText(bcoord.coord),initcap(b.name) from vw_boundary_coord bcoord, tb_boundary b where bcoord.type='District' and b.id=bcoord.id_bndry order by b.name",
              ...
              'get_school':"select inst.instid, ST_AsText(inst.coord), upper(s.name), s.cat from vw_inst_coord inst, tb_school s,tb_boundary b where s.id=inst.instid and s.bid=502 or s.bid=421 or s.bid=9040 or s.bid=420 or s.bid=496 or s.bid=1179 or s.bid=1181 or s.bid=1150 or s.bid=419 or or s.bid=493 or s.bid=419 or s.bid=1149 or s.bid=1151 and b.type='1' order by s.name",
