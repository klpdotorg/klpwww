...
(
  ...
  children_from_weaker_section_applied character varying(3), 
  children_from_weaker_section_enrolled character varying(3), 
  aid_received character varying(3), 
  chilren_admitted_for_free_education character varying(3), 
  ...
  textbook_received character varying(3), 
