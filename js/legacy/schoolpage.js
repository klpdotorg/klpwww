...
{
  info=data;
  document.getElementById("school_info").innerHTML ="Loading <img style='vertical-align:middle' src='/images/legacy/ajax-loader-bar.gif'/>";
  document.getElementById("student_gend").innerHTML = "Loading <img style='vertical-align:middle' src='/images/legacy/ajax-loader-bar.gif'/>";
  document.getElementById("assessment_info").innerHTML = "Loading <img style='vertical-align:middle' src='/images/legacy/ajax-loader-bar.gif'/>";
  document.getElementById("mdm_info").innerHTML = "Loading <img style='vertical-align:middle' src='/images/legacy/ajax-loader-bar.gif'/>";
  document.getElementById("infra_info").innerHTML = "Loading <img style='vertical-align:middle' src='/images/legacy/ajax-loader-bar.gif'/>";
  document.getElementById("sys_data").innerHTML = "Loading <img style='vertical-align:middle' src='/images/legacy/ajax-loader-bar.gif'/>";
  document.getElementById("library_data").innerHTML="Loading <img style='vertical-align:middle' src='/images/legacy/ajax-loader-bar.gif'/>";
  document.getElementById("levelimage").style.display='none';
  if(info["type"] == 1) {
  	document.getElementById("finances_txt").innerHTML = "Loading <img style='vertical-align:middle' src='/images/legacy/ajax-loader-bar.gif'/>";
  	document.getElementById("mdm_info").innerHTML = "Loading <img style='vertical-align:middle' src='/images/legacy/ajax-loader-bar.gif'/>";
  }
  tab_str = info["tab"];
...
function populateFinances()
{
	...
	fin_info = "";
	   ...
	   fin_info = "<dl><dt>School Maintenance Grant (SMG)</dt><dd><img src=\"/images/legacy/Rupee.png\"/> 5,000 for upto 3 classrooms " +
	              "and <img src=\"/images/legacy/Rupee.png\"/> 10,000 for more than 3 classrooms. </dd><dt>School Grant (SG)</dt><dd>" +
	              "<img src=\"/images/legacy/Rupee.png\"/> 5,000 for lower primary schools and <img src=\"/images/legacy/Rupee.png\"/> 7,000 " +
	              "for upper and model  primary schools</dd><dt>Teacher Learning Material Grant (TLM)</dt><dd><img src=\"/images/legacy/Rupee.png\"/> " +
        ...
        if (outer_dict) {
	       ...
	       if(firstrow > 0){
               ...
               if(innerdict[key] == 100){
                	tabletxt += '<div class="div-table-col" style="width:30px;text-align:center"><img src="/images/legacy/green_round.png" width="15px"/></div>';
               } else if (innerdict[key] == 0) {
                        tabletxt += '<div class="div-table-col" style="width:30px;text-align:center"><img src="/images/legacy/red_round.png" width="15px"/></div>';
               } else {
                  tabletxt += '<div class="div-table-col" style="width:30px;text-align:center"><img src="/images/legacy/grey_round.png" width="15px"/></div>';
               }
	       tabletxt += '</div>';
             }
	   }
           tabletxt += '<div class="div-table-row"><div class="div-table-col" style="width:500px"><img src="/images/legacy/red_round.png" style="width:15px"> - indicates that the infrastructure does not exist, <img src="/images/legacy/green_round.png" style="width:15px"> - indicates that it exists and <br/><img src="/images/legacy/grey_round.png" style="width:15px"> - indicates that information is unavailable.</div></div>';
           tabletxt += '</div>';
	   infra_info=tabletxt;
        } else {
...
function populatePTR()
{
	if (info["type"]==2) {
           ...
           if( parseInt(info['student_count']/info['teacher_count']) > 30 ) {
             tabletxt += '<div class="div-table-col" style="width:30px;text-align:center"><img src="/images/legacy/red_round.png" width="15px"/>';
           } else {
             tabletxt += '<div class="div-table-col" style="width:30px;text-align:center"><img src="/images/legacy/green_round.png" width="15px"/>';
           }
           tabletxt += '(' + parseInt(info['student_count']/info['teacher_count']) + ':1)</div></div>';
           tabletxt += '<div class="div-table-row"><div class="div-table-col" style="width:300px"><img src="/images/legacy/red_round.png" style="width:15px"> - indicates that the ratio is greater than 30:1,<br/> <img src="/images/legacy/green_round.png" style="width:15px"> - indicates that the ratio is lesser than 30:1.</div></div>';
        } else {
...
function ConvertToIndian(inputString) {
      ...
      return '<img src="/images/legacy/Rupee.png" style="vertical-align:middle"/>&nbsp;' + outputString;
}
